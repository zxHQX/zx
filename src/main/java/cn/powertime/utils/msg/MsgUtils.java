...
public class MsgUtils {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="1dc2523f3ec0d2f94f441f3b539c12ae";
    ...
    public static void check(){
        ...
        params.put("word","hehe");//需要检测的短信内容，需要UTF8 URLENCODE
    ...
    public static void sendMsg(String phoneNum,String code){
        code = "%23code%23%3D"+code;
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile",phoneNum);//接收短信的手机号码
        params.put("tpl_id","139496");//短信模板ID，请参考个人中心短信模板设置
