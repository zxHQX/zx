package cn.powertime.utils.logging.util;

import cn.powertime.utils.logging.exception.UncheckedException;
...
public abstract class Assert {
	 ...
	 *            错误信息
	 */
	public static void isThanZero(int num, String message) {
		if (num <= 0) {
	...
	/** 
	 * 方法用途: 断言num不为null，并且num大于0。
	 * 实现步骤: 
	 * @param num
	 * @param message   
	 */
	public static void isThanZero(Integer num, String message) {
		if (num == null || num <= 0) {
			throw new UncheckedException(message);
		}
	}
